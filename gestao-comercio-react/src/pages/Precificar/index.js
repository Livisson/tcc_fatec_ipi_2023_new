    ...
    <Container fluid style={{ backgroundColor: "white" }}>
      <Row className="justify-content-md-center">
        ...
        <div className="col" style={{textAlign: "left", verticalAlign: "middle", alignSelf: "center"}} xs={6}>
          <label style={{fontSize:22, fontWeight: "bold", color: "gray"}}>PRECIFICAÇÃO</label>
        </div>
          ...
          <Row className="justify-content-md-center">
            <div className="d-flex justify-content-between">
              <div className="d-flex align-items-center mb-4">
                ...
                <DropdownButton 
                  id="filtro-dropdown" 
                  title={fornecedorFiltro && fornecedores.find(fornecedor => fornecedor.cnpj === fornecedorFiltro)?.nome ? fornecedores.find(fornecedor => fornecedor.cnpj === fornecedorFiltro).nome : "Selecione um Fornecedor"} 
                  variant="outline-secondary"
                >
                  {fornecedores.map((fornecedor) => (
                    <Dropdown.Item 
                      ...
                      key={fornecedor.cnpj} 
                      eventKey={fornecedor.cnpj} 
                      onClick={handleSelectFiltro.bind(this, fornecedor.cnpj, fornecedor.eventKey)} 
